...
class Social extends React.Component {
  constructor(props) {
    ...
    console.log(
      'Social Component - constructor with props : ',
      this.props,
  ...
  render() {
    ...
    return (
      <div className='social-media-div text-[2em] text-center w-full flex items-center justify-center'>
        <a href={GITHUB_LINK} className='mb-2.5' target='_blank'>
          <i className='bg-github icon--i'>
            <SiGithub className='m-auto' />
          </i>
        </a>
        <a href={LINKEDIN_LINK} className='mb-2.5' target='_blank'>
          <i className='bg-linkedin icon--i'>
            <SiLinkedin className='m-auto' />
          </i>
        </a>
        <a href={GMAIL_LINK} className='mb-2.5'>
