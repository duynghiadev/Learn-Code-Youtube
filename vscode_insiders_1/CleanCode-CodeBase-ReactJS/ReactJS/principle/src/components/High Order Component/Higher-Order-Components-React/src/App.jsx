      ...
      <div>
        <nav className='navbar navbar-expand-lg navbar-dark '>
          <ul className='navbar-nav mr-auto'>
            ...
            <li>
              <Link to='/loaderdemo'>Loader Demo</Link>
            </li>
            <li>
              <Link to='/genericcontainer'>Generic Container/State abstraction</Link>
            </li>
            <li>
            ...
            <li>
              <Link to='/requireauth'>Protected Routes Demo</Link>
            </li>
          </ul>
        </nav>
...
const Home = () => {
  return <div> You are at Home </div>
}
export default App
