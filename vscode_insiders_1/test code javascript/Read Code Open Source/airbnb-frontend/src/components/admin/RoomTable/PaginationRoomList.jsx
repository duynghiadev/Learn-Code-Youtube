...
const PaginationRoomList = ({
  rooms,
  roomFrom,
  selectPaginationRoom,
  selectPaginationRoomNextPrev,
}) => {
  let totalPagination = Math.ceil(rooms?.length / 10);
      ...
      return (
        <li key={item}>
          <button
            ...
            onClick={() => selectPaginationRoom(item)}
          >
            {item}
          </button>
        </li>
        ...
        <ul className="inline-flex items-center">
          <li>
            <button
              ...
              aria-label="Previous"
              onClick={() => selectPaginationRoomNextPrev(-1)}
            >
              <svg
                aria-hidden="true"
...
export default PaginationRoomList;
