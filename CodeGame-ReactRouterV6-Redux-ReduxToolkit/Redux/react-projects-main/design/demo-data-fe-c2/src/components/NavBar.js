...
const NavBar = () => {
  ...
  return (
    <nav className='max-w-[1240px] mx-auto p-6 flex flex-row justify-between h-24 items-center'>
      <a href='/' className='text-2xl text-brightGreen font-bold uppercase md:text-3xl'>
        react.
      </a>
      ...
      <div className='md:hidden'>
        {!isMobileMenuOpen && (
          <AiOutlineMenu className='text-white cursor-pointer text-xl' onClick={toggleMobileMenu} />
        )}
        {isMobileMenuOpen && (
          <AiOutlineClose
      ...
      >
        <a href='/' className='m-4 text-2xl text-brightGreen font-bold uppercase md:text-3xl'>
          react.
        </a>
