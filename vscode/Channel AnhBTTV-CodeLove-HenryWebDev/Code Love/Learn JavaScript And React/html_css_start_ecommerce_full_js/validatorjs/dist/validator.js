  ...
  })()(
    {
          ...
          Messages.prototype = {
            ...
            render: function (rule) {
              ...
              if (Attributes.replacements[rule.name]) {
                message = Attributes.replacements[rule.name].apply(this, [
                  template,
                  rule
                ])
              } else {
        ...
        function (require, module, exports) {
          ...
          var rules = {
            ...
            same: function (val, req) {
              var val1 = this.validator._flattenObject(this.validator.input)[
                req
              ]
              var val2 = val
            ...
            ip: function (val, req, attribute) {
              return (
                rules['ipv4'](val, req, attribute) ||
                rules['ipv6'](val, req, attribute)
              )
            }
          }
              ...
              if (typeof callback === 'function') {
                ...
                if (this.async) {
                  ...
                  return handleResponse(
                    this._apply(inputValue, ruleValue, attribute)
                  )
                }
              }
      ...
      8: [
        function (require, module, exports) {
          ...
          Validator.prototype = {
            ...
            _parsedRulesRecurse: function (
              ...
              if (propertyValue) {
                for (
                  ...
                  var workingValues = wildCardValues
                    ? wildCardValues.slice()
                    : []
              ...
              for (var i = 0, len = rulesArray.length, rule; i < len; i++) {
                rule =
                  typeof rulesArray[i] === 'string'
                    ...
                    : rulesArray[i]
                if (rule.value) {
                  rule.value = this._replaceWildCards(
                    rule.value,
                    wildCardValues
                  )
            ...
            _checkAsync: function (funcName, callback) {
              ...
              if (this.hasAsync && !hasCallback) {
                throw (
                  funcName +
                  ' expects a callback when async rules are being tested.'
                )
              }
           ...
           * @return {void}
           */
          Validator.registerImplicit = function (
            name,
            fn,
            message,
            fnReplacement
           ...
           * @return {void}
           */
          Validator.registerAsync = function (
            name,
            fn,
            message,
            fnReplacement
