...
// biến đổi từ Object sang Array
const reduceUsers = users.reduce((acc, cur) => {
  // accumulate: tích lũy, current value: giá trị hiện tại
  return { ...acc, [cur.email]: cur };
}, {});

const arrayUsers = Object.values(reduceUsers).reduce((acc, cur) => {
