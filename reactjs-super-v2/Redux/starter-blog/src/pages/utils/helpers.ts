 ...
 * ✅ Đầu tiên chúng ta phải khai báo một function check kiểm tra cấu trúc về mặt logic JavaScript
 ...
 *
 * So sánh với phương pháp ép kiểu "Type Assertions" thì ép kiểu chúng giúp chúng ta đúng về mặt Type, chưa chắc về logic
 */
...
/**
 * Thu hẹp một error có kiểu không xác định về 1 object với thuộc tính message: string (SerializedError)
 */
