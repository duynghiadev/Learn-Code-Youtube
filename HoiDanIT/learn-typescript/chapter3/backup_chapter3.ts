...
console.log(">>> check sum 4 = ", sum5(2, 5), sum5(1, 2, 3)); //NaN : not a number;; null/ undefined
...
console.log(`There is a ${discount11}% on ${product.name}.`);
...
console.log(`You got ${discount1}% discount1. `);
