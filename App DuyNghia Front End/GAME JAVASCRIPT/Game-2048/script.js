...
function centerCanvas() {
  var x = (windowWidth - width) / 2; //center horizontally
  var y = (windowHeight - height) / 2 + 40; //center vertically
  canvas.position(x, y);
}
...
/* combines tiles of the same value together downwards or to the right */
