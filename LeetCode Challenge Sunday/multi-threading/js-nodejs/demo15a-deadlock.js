...
const mainFunc = async () => {
  try {
    ...
    const [wkFoo, promFoo] = mylib.createThread(new URL(import.meta.url), ['foo', mutex.getSAB()])
    const [wkBar, promBar] = mylib.createThread(new URL(import.meta.url), ['bar', mutex.getSAB()])
