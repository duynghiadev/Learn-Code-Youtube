...
let products = [
  ...
  },
  {
    ...
    price: '300',
    image:
      'https://images.unsplash.com/photo-1549298916-b41d501d3772?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=812&q=80',
    description: 'mô tả 2',
    type: 'new_arrival',
  ...
  },
  {
    ...
    price: '200',
    image:
      'https://images.unsplash.com/photo-1543508282-6319a3e2621f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=415&q=80',
  ...
  },
  {
    ...
    price: '300',
    image:
      'https://images.unsplash.com/photo-1603808033192-082d6919d3e1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=415&q=80',
    description: 'anh 2.1',
    type: 'new_arrival',
    category_id: '73afbeb2-fcb2-4210-ae8b-d92ac8260302'
  },
  {
    ...
    price: '200',
    image:
      'https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=725&q=80',
    description: 'anh 2.3',
    type: 'new_arrival',
    category_id: '73afbeb2-fcb2-4210-ae8b-d92ac8260302'
  }
...
let users = [
  ...
  // 1 sản phảm
  ({ id: 1, name: 'giay the thao', quantity: 2 }, { id: 2, name: 'quan ao', quantity: 1 })
]
