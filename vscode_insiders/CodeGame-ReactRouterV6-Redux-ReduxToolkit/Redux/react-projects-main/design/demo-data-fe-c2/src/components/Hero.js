...
const Hero = () => {
  return (
    <div className='mt-[-96px] h-screen max-w-[900px] mx-auto flex flex-col space-y-5 items-center justify-center md:space-y-10'>
      <p className='uppercase text-brightGreen text-sm font-bold'>growing with data analytics</p>
      <h1 className='text-4xl text-white font-bold sm:text-5xl md:text-7xl'>Grow with data.</h1>
