...
// RENDER ARTICLES NEW
API.call().get('articles?limit=5').then((res) => {
  const articles = res.data.data;
...
API.call().get('categories_news/articles?limit_cate=2&limit=9').then((res) => {
...
API.call().get('categories_news/articles?limit_cate=4&limit=4').then((res) => {
  const data = res.data.data;
